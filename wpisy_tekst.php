			...
			<section id="Karuzela" class="carousel slide" data-ride="carousel">
			  ...
			  <div class="carousel-inner">
				<div class="carousel-item active">
				  <img class="d-block w-100" src="top2.jpg" alt="Pierwszy slajd" width="800" height="900">
				</div>
				<div class="carousel-item">
				  <img class="d-block w-100" src="top1.jpg" alt="Drugi slajd" width="800" height="900">
				</div>
				<div class="carousel-item">
				  <img class="d-block w-100" src="top3.jpg" alt="Trzeci slajd" width="800" height="900">
				</div>
			  </div>
